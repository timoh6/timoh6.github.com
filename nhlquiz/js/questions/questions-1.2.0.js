questionData = [
    ...
    {
        question: 'In the history of the NHL only three players has scored over 80 goals in a season. They are: Wayne Gretzky, Mario Lemieux and... ',
        answers: [
    ...
    {
        question: 'Who was the first European named All-Star Game MVP in the NHL?',
        answers: [
            { id: 0, answer: 'Dominik Hašek' },
            { id: 1, answer: 'Teemu Selänne' },
            { id: 2, answer: 'Jaromír Jágr' }
        ],
        currentAnswer: ko.observable(-2),
        correctAnswer: 1,
    ...
    {
        question: 'Two of the following legends were first round picks, but who of them was number 117 pick in the NHL entry draft?',
        answers: [
            { id: 0, answer: 'Brett Hull' },
            { id: 1, answer: 'Joe Sakic' },
            { id: 2, answer: 'Steve Yzerman' }
        ],
        currentAnswer: ko.observable(-2),
        correctAnswer: 0,
        comment: '“The 1984 Entry Draft is noted for the unusually high number of future Hall of Famers picked, particularly in lower rounds”. Brett Hull was chosen in the sixth round by Calgary Flames being number 117 pick. For more information, see <a href="https://en.wikipedia.org/wiki/1984_NHL_Entry_Draft">Wikipedia</a>.'
    }
];