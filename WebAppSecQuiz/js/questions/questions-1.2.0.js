questionData = [
    ...
    },
    {
        ...
        answers: [
            ...
            { id: 1, answer: 'A hash (eg. SHA-1) of 20 bytes of random data from <span class="text-info">/dev/urandom</span>' },
            { id: 2, answer: 'A hash (eg. SHA-1) of user&#039;s username, password and a salt concatenated' }
