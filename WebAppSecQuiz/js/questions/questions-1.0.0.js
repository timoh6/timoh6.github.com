questionData = [
    ...
    {
        question: 'Placing user submitted data into a typical HTML document is always safe (XSS-wise) if you escape HTML specific characters:<br><span class="text-info">&lt;</span>, <span class="text-info">&gt;</span>, <span class="text-info">&amp;</span>, <span class="text-info">&#039;</span>, <span class="text-info">&quot;</span><br>from the user input. Ie. you use <span class="text-info">htmlspecialchars()</span> funtion in PHP?',
        answers: [
            { id: 0, answer: 'Yes' },
